...
CREATE TABLE BATCH_STEP_SEQ (
    ID BIGINT NOT NULL,
    constraint BATCH_STEP_SEQ_PK primary key (ID)
);

CREATE TABLE BATCH_JOB_EXECUTION_SEQ (
    ID BIGINT NOT NULL,
    constraint BATCH_JOB_EXECUTION_SEQ_PK primary key (ID)
);

CREATE TABLE BATCH_STEP_EXECUTION_SEQ (
    ID BIGINT NOT NULL,
    constraint BATCH_STEP_EXECUTION_SEQ_PK primary key (ID)
);

INSERT INTO BATCH_JOB_SEQ (ID) VALUES (0);
INSERT INTO BATCH_STEP_SEQ (ID) VALUES (0);
